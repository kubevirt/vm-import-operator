...
type ResourceMappingInterface interface {
	Create(*v1beta1.ResourceMapping) (*v1beta1.ResourceMapping, error)
	Update(*v1beta1.ResourceMapping) (*v1beta1.ResourceMapping, error)
	UpdateStatus(*v1beta1.ResourceMapping) (*v1beta1.ResourceMapping, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ResourceMapping, error)
	List(opts v1.ListOptions) (*v1beta1.ResourceMappingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ResourceMapping, err error)
...
func (c *resourceMappings) Get(name string, options v1.GetOptions) (result *v1beta1.ResourceMapping, err error) {
...
func (c *resourceMappings) List(opts v1.ListOptions) (result *v1beta1.ResourceMappingList, err error) {
...
func (c *resourceMappings) Create(resourceMapping *v1beta1.ResourceMapping) (result *v1beta1.ResourceMapping, err error) {
	result = &v1beta1.ResourceMapping{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourcemappings").
...
func (c *resourceMappings) Update(resourceMapping *v1beta1.ResourceMapping) (result *v1beta1.ResourceMapping, err error) {
	result = &v1beta1.ResourceMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcemappings").
...
func (c *resourceMappings) UpdateStatus(resourceMapping *v1beta1.ResourceMapping) (result *v1beta1.ResourceMapping, err error) {
	result = &v1beta1.ResourceMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourcemappings").
...
func (c *resourceMappings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ResourceMapping, err error) {
	result = &v1beta1.ResourceMapping{}
