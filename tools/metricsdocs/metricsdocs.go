...
const (
	title      = "#  Virtual Machine Import metrics\n"
	background = "This document aims to help users that are not familiar with metrics exposed by the  Virtual Machine Import.\n" +
		"All metrics documented here are auto-generated by the utility tool `tools/metricsdocs` and reflects exactly what is being exposed.\n\n"

	KVSpecificMetrics = "##  Virtual Machine Import Metrics List\n"
...
const filter = "kubevirt_vmimport_"
